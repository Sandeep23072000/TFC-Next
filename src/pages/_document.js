...
export default function Document() {
  return (
    <Html lang="en">
      ...
      {/* <!-- JAVASCRIPT FILES ========================================= --> */}
      <script async src="../assets/js/jquery.min.js"></script>{/* <!-- JQUERY.MIN JS --> */}
      <script async src="../assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
      {/* <!-- BOOTSTRAP.MIN JS --> */}
      <script async src="../assets/vendor/bootstrap-select/js/bootstrap-select.min.js"></script>
      {/* <!-- BOOTSTRAP SELEECT --> */}
      <script async src="../assets/vendor/magnific-popup/magnific-popup.js"></script>
      {/* <!-- MAGNIFIC POPUP JS --> */}
      <script async src="../assets/vendor/counter/waypoints-min.js"></script>
      {/* <!-- WAYPOINTS JS --> */}
      <script async src="../assets/vendor/wow/wow.js"></script>
      {/* <!-- WOW JS --> */}
      <script async src="../assets/vendor/counter/counterup.min.js"></script>
      {/* <!-- COUNTERUP JS --> */}
      <script async src="../assets/vendor/swiper/swiper-bundle.min.js"></script>
      {/* <!-- OWL-CAROUSEL --> */}
      <script async src="../assets/vendor/popper/popper.js"></script>
      {/* <!-- Popper --> */}
      <script async src="../assets/vendor/tempus-dominus/js/tempus-dominus.min.js"></script>
      {/* <!-- Tempus Dominus --> */}
      <script async src="../assets/vendor/tilt/tilt.jquery.min.js"></script>
      {/* <!-- TILT --> */}
      <script async src="../assets/js/dz.carousel.min.js"></script>
      {/* <!-- OWL-CAROUSEL --> */}
      <script async src="../assets/js/dz.ajax.js"></script>
      {/* <!-- AJAX --> */}
      <script async src="../assets/js/custom.min.js"></script>
      {/* <!-- CUSTOM JS --> */}
      <script async src="../assets/vendor/rangeslider/rangeslider.js"></script>
      <script async src="../assets/vendor/switcher/switcher.js"></script>
    </Html>
  )
}
