        ...
        <div className="container">
          <div className="swiper team-swiper swiper-visible swiper-btn-lr">
            <div className="swiper-wrapper">
                ...
                <div className="dz-team style-1 wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <div className="dz-content">
                    <div className="clearfix">
                      <h6 className="dz-name"><a href="team-detail.html">Sarah Albert</a></h6>
              ...
              <div className="swiper-slide">
                <div className="dz-team style-1 wow fadeInUp" data-wow-delay="0.4s">
                  <div className="dz-media">
                    <img src="../assets/images/team/pic2.jpg" alt="/" />
                  </div>
                  <div className="dz-content">
                    <div className="clearfix">
                      <h6 className="dz-name"><a href="team-detail.html">John Doe</a></h6>
                      <span className="dz-position">Senior Chef</span>
                    </div>
                    <ul className="team-social">
                      <li>
              ...
              <div className="swiper-slide">
                <div className="dz-team style-1 wow fadeInUp" data-wow-delay="0.6s">
                  <div className="dz-media">
                    <img src="../assets/images/team/pic3.jpg" alt="/" />
                  </div>
                  <div className="dz-content">
                    <div className="clearfix">
                      <h6 className="dz-name"><a href="team-detail.html">Jemy Carline</a></h6>
              ...
              <div className="swiper-slide">
                <div className="dz-team style-1 wow fadeInUp" data-wow-delay="0.8s">
                  <div className="dz-media">
                    <img src="../assets/images/team/pic4.jpg" alt="/" />
                  </div>
                  <div className="dz-content">
                    <div className="clearfix">
                      <h6 className="dz-name"><a href="team-detail.html">Cotlin Care</a></h6>
                      <span className="dz-position">Senior Chef</span>
                    </div>
                    <ul className="team-social">
                      <li>
